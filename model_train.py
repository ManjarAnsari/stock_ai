...
interval = "1d"
period = "6mo"
# 🔴 model_dir = "models"  ← removed
# 🔴 global_model_path = os.path.join(model_dir, "global_model.pkl")
global_model_path = "global_model.pkl"  # 🔴 Save in current folder
...
# --- Save Model ---
# 🔴 os.makedirs(model_dir, exist_ok=True)  ← removed
joblib.dump(model, global_model_path)
print(f"🎯 Global model saved as {global_model_path}")  # 🔴 message updated
